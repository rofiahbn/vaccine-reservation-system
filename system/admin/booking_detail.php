...
<head>
    ...
    <link rel="stylesheet" href="system/admin/css/reschedule.css">
...
<div id="popupCetakSurat" class="popup-cetak-surat">
    ...
    <script src="system/admin/js/detail_edit.js"></script>
    <script src="system/admin/js/detail.js"></script>
    <script src="system/admin/js/reschedule.js"></script>
    <script src="system/admin/js/cetak_surat_detail.js"></script>
    <script src="system/admin/js/add_participant.js"></script>
