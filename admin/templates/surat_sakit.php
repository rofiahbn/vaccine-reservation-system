<div class="surat-template">
    ...
    <table class="data-pasien">
        ...
        <tr>
            <td>Tanggal Lahir</td>
            <td>: <span id="pv_tgl_lahir"></span></td>
        </tr>
        <tr>
            <td>Usia</td>
            <td>: <span id="pv_usia"></span></td>
        </tr>
        <tr>
            <td>Jenis Kelamin</td>
            <td>: <span id="pv_jk"></span></td>
        </tr>
        <tr>
            <td>Tanggal Pembuatan</td>
            <td>: <span id="pv_tanggal_surat"></span></td>
        </tr>
    </table>
    ...
    <table class="data-istirahat">
        <tr>
            <td>Lama</td>
            <td>: <b><span id="pv_lama"></span> hari</b></td>
        </tr>
        <tr>
            <td>Tanggal Awal</td>
            <td>: <span id="pv_tgl_awal"></span></td>
        </tr>
        <tr>
            <td>Tanggal Akhir</td>
            <td>: <span id="pv_tgl_akhir"></span></td>
        </tr>
    </table>
